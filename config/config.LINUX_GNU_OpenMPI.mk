...
EXEC_SUFFIX = _linux_gnu_openmpi
...
#CGNS_INCLUDE_FLAGS = -I/usr/local/CGNS/cgns3.2/include
#CGNS_LINKER_FLAGS  = -L/usr/local/CGNS/cgns3.2/lib -lcgns\
		     -L/usr/local/HDF5/hdf5-1.8.12/lib -lhdf5\
...
FF90_GEN_FLAGS = -fallow-argument-mismatch
CC_GEN_FLAGS   =

FF90_OPTFLAGS   = -msse4.2 -O2 -funroll-loops -ftree-vectorize -march=native
CC_OPTFLAGS     = -O2
